...
const demo = (slug: string) => `/demos/${slug}`;
...
export const projects: Project[] = [
  {
    ...
    solution: [
      ...
      "Голосовое управление: кодовое слово «AURA» включает слушание, ответы озвучиваются синтезом речи",
    ...
    features: [
      ...
      "Женственный голос: скажите «AURA, привет» — ответ прозвучит вслух",
